...
const ButtonEditInvoice: React.FC = ({ ...props }) => {
  return (
    <Styles.Button {...props}>
      <Styles.Icon
...
export default ButtonEditInvoice;
